<?php 
    ...
    /* cau hinh ngon ngu */
    file_exists(_PHISICAL_PATH_ROOT.'language/lang_vn.php')?include_once(_PHISICAL_PATH_ROOT.'language/lang_vn.php'):die(_PHISICAL_PATH_ROOT.'language/lang_vn.php khong ton tai');
    ...
    file_exists(_PHISICAL_PATH_ROOT.'config/define.php')?include_once(_PHISICAL_PATH_ROOT.'config/define.php'):die(_PHISICAL_PATH_ROOT.'config/define.php khong ton tai');
    /* khai bao attribute */
    file_exists(_PHISICAL_PATH_ROOT.'config/define_general.php')?include_once(_PHISICAL_PATH_ROOT.'config/define_general.php'):die(_PHISICAL_PATH_ROOT.'config/define_general.php khong ton tai');
