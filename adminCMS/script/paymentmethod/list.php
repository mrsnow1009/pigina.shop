...
<script type="text/javascript">
	...
	$(document).ready(function () {
		...
		if ($('#table-paymentmethod').length == 1) {
		   	var table_donate = $('#table-paymentmethod').DataTable({
		   		order: [[2, 'asc']],
		      	pageLength: <?php echo _MAX_RECORD_PAYMENTMETHOD;?>,
		      	// "lengthChange": false,
				...
				serverSide: true,
			    ajax: {
			        "url": "<?php echo _ROOT_PATH_ADMIN_AJAX;?>?q=_paymentmethod_list",
			        type: 'POST'
			    }
		   	});
	        ...
	        $('#table-paymentmethod tbody').on('click', 'td.dt-control', function () {
