...
<script type="text/javascript">
	...
	$(document).ready(function () {
		...
		if ($('#table-unit').length == 1) {
		   	var table_donate = $('#table-unit').DataTable({
		   		order: [[2, 'asc']],
		      	pageLength: <?php echo _MAX_RECORD_UNIT;?>,
		      	// "lengthChange": false,
				...
				serverSide: true,
			    ajax: {
			        "url": "<?php echo _ROOT_PATH_ADMIN_AJAX;?>?q=_unit_list",
			        type: 'POST'
			    }
		   	});
	        ...
	        $('#table-unit tbody').on('click', 'td.dt-control', function () {
