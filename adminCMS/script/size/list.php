...
<script type="text/javascript">
	...
	$(document).ready(function () {
		...
		if ($('#table-size').length == 1) {
		   	var table_donate = $('#table-size').DataTable({
		   		order: [[2, 'asc']],
		      	pageLength: <?php echo _MAX_RECORD_SIZE;?>,
		      	// "lengthChange": false,
				...
				serverSide: true,
			    ajax: {
			        "url": "<?php echo _ROOT_PATH_ADMIN_AJAX;?>?q=_size_list",
			        type: 'POST'
			    }
		   	});
	        ...
	        $('#table-size tbody').on('click', 'td.dt-control', function () {
