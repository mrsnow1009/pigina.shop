...
<script type="text/javascript">
	...
	$(document).ready(function () {
		...
		if ($('#table-deliverymethod').length == 1) {
		   	var table_donate = $('#table-deliverymethod').DataTable({
		   		order: [[2, 'asc']],
		      	pageLength: <?php echo _MAX_RECORD_DELIVERYMETHOD;?>,
		      	// "lengthChange": false,
		      	scrollCollapse: _scrollCollapse,
		  		scrollX: _scrollX,
		      	columnDefs: [
		        	{ searchable: false, orderable: false, targets: [0,1,4] },
				...
				serverSide: true,
			    ajax: {
			        "url": "<?php echo _ROOT_PATH_ADMIN_AJAX;?>?q=_deliverymethod_list",
			        type: 'POST'
			    }
		   	});
	        ...
	        $('#table-deliverymethod tbody').on('click', 'td.dt-control', function () {
