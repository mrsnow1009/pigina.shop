	...
	<div class="alert alert-primary p-2" role="alert">
		<nav aria-label="breadcrumb">
		  	<ol class="breadcrumb mb-0">
		    	...
		    	<li class="breadcrumb-item"><a href="<?php echo _LINK_CATEGORY_LIST; ?>&node=<?php echo $node; ?>" title=""><?php echo $LANG['category-list']; ?></a></li>
		    	<li class="breadcrumb-item active" aria-current="page"><?php echo $page_title; ?></li>
		  	</ol>
		</nav>
	</div>
	<section class="box-section mb-3">
		<form action="" role="form" method="post" id="form_updateCategory">
			<div class="row">
				<div class="col-md-6">
					<div class="row mb-3">
						<div class="col-xl-4">
				...
				<div class="col-md-6">
					<div class="row mb-3">
						<div class="col-xl-4">
							<label for="cbx_parentid" class="col-form-label"><?php echo $LANG['choose_category']; ?> <span class="text-danger">(*)</span></label>
						</div>
						<div class="col-xl-8">
							<select class="form-select" id="cbx_parentid" name="cbx_parentid" required="required">
				...
				<div class="col-md-6">
					<div class="row mb-3">
						<div class="col-xl-4">
							<label for="txt_title" class="col-form-label"><?php echo $LANG['name_category']; ?> <span class="text-danger">(*)</span></label>
						</div>
						<div class="col-xl-8">
				...
				<div class="col-md-6">
					<div class="row mb-3">
						...
						<div class="col-xl-8">
							<input type="text" onfocus="geturlseo();" class="form-control" id="txt_urlseo" name="txt_urlseo" value="<?php echo $txt_urlseo; ?>" placeholder="<?php echo $LANG['placeholder_url_friendly']; ?>"  required="required">
						</div>
					</div>
				</div>
				<div class="col-md-6">
				...
				<div class="col-md-6">
					<div class="row mb-3">
						<div class="col-xl-4">
							<label for="cbx_menu_1" class="col-form-label"><?php echo $LANG['show_cate_at']; ?></label>
						</div>
						<div class="col-xl-8">
							<?php echo $checkMenu; ?>
						</div>
			...
			<div class="row">
				<div class="col-md-6">
					<div class="row mb-3">
						...
						<div class="col-xl-8">
							<input type="hidden" value="add_cate" name="act_cate" id="act_cate" required="required">
							<button class="btn btn-primary me-2" type="submit"><?php echo $LANG['save_information']; ?></button>
							<a class="btn btn-warning" href="<?php echo _LINK_CATEGORY_LIST; ?>&node=<?php echo $node; ?>" title="<?php echo $LANG['cancel']; ?>"><?php echo $LANG['cancel']; ?></a>
						</div>
					</div>
				</div>
			</div>
		...
		<section class="box-section mb-3">
			<div class="border border-info border-opacity-25 rounded p-3">
				<?php echo $LANG['note_create_category']; ?>
			</div>
		</section>
	</section>
</div>