<div class="page-home">
	...
	<section class="box-section mb-3">
		<form action="" role="form" method="post" id="form_updateSize">
			<div class="row">
				<div class="col-md-6">
					<div class="row mb-3">
						<div class="col-xl-4">
			...
			<div class="row">
				<div class="col-md-6">
					<div class="row mb-3">
						...
						<div class="col-xl-8">
							<input type="hidden" value="add_size" name="act_size" id="act_size" required="required">
							<button class="btn btn-primary me-2" type="submit"><?php echo $LANG['save_information']; ?></button>
							<a class="btn btn-warning" href="<?php echo _LINK_SIZE_LIST; ?>" title="<?php echo $LANG['cancel']; ?>"><?php echo $LANG['cancel']; ?></a>
						</div>
					</div>
				</div>
			</div>
