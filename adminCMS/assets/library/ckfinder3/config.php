...
include('./../../../../../../../config/identify.php');
include('./../../../../../../../config/config_global.php');
$baseUrl = _PATH_UPLOAD_EDITOR;
...
$config['licenseName'] = $WEBCONFIG['DomainName'];
$config['licenseKey']  = $WEBCONFIG['licenseCKFinder'];
...
$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      => $baseUrl,/* '/ckeditor5/ckfinder/userfiles/' */
