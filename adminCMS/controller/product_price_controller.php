...
class product_price_controller {
	private $table = TBLPRODUCT_PRICE;
	private $_id;
	...
	private function format_std($object = array()){
		...
		isset($object['color_id']) ? $result->color_id = $object['color_id'] : $result->color_id = '';
		isset($object['size_id']) ? $result->size_id = $object['size_id'] : $result->size_id = '';
