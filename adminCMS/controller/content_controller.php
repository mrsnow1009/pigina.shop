...
class content_controller {
	...
	private function format_std($object = array()){
		...
		isset($object['type_art']) ? $result->type_art = $object['type_art'] : $result->type_art = '';
	...
	function DeleteRecord($str_id){
		...
		for($i=0;$i<count($arrId);$i++){
			...
			$rf = $this->Delete(_LEVEL_ADMIN._PATH_UPLOAD_ARTICLE.$arrId[$i]);/* delete folder */
