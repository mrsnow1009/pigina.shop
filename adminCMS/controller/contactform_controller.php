...
class contactform_controller {
	...
	private function format_std($object = array()){
		...
		isset($object['subject']) ? $result->subject = $object['subject'] : $result->subject = '';
		isset($object['message']) ? $result->message = $object['message'] : $result->message = '';
